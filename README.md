...
Complete replacement package — version `v9.4.9_weighted_period_oee`, built on the verified v9.4.3 OEE IWON package.
...
1. Extract `LianBo_Project_Performance_Hub_v9.4.9.zip` on the computer.
